...
const Skeleton = () => {
  const skills = [
    ...
    { logo: FaGitAlt, name: "Git", link: "https://git-scm.com/" },
    { logo: DiTerminal, name: "Terminal", link: "https://en.wikipedia.org/wiki/Terminal_emulator" },
    { logo: DiGoogleDrive, name: "Drive", link: "https://www.google.com/drive/" },
